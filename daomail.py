...
def checkhotmail():
  ...
  def run_check_hotmail(hot_mail):
    ...
    if kq == None:
      print (" \033[1;31m➣ |\033[1;37mHTOOL\033[1;31m|Email Live|" + hot_mail + "@hotmail.com")
      open(hotmail_live,'a').write(hot_mail + "@hotmail.com" + "\n")
    else:
      print (" \033[1;32m➣ |\033[1;37mHTOOL\033[1;32m|Email Die|" + hot_mail + "@hotmail.com")
...
def checkyahoo():
  ...
  def run_check_yahoo(yid):
    ...
    if KQ == None:
      print(" ☇ |\033[1;37mHTOOL\033[1;32m|Email Die🤣| " + yid + "@yahoo.com")
      open(yahoo_die,"a").write(yid + "@yahoo.com" + "\n")
    else:
      print(" ☇ |\033[1;37mHTOOL\033[1;31m|Email Live🙁| " + yid + "@yahoo.com")
...
def checkvalid():
  ...
  try:
    ...
    print ("   \033[1;93m•FAKE IP TRƯỚC CHẠY TOOL MẤY THẰNG NGU")
    print ("   \033[1;93m•MỖI IP CHECK ĐƯỢC 50-80 MAIL THÔI ,ĐỔI IP KHÁC DDEEEE ")
    fileEmail = open(input(" \033[1;34m➣ Nhập File Chứa Email(ex: Mail.txt) : ")).readlines()
    valid = input(" \033[1;34m➣ Nhập File Lưu Email Valid Facebook(ex: Maillk.txt) : ")
  except:
    print (" \033[1;31mKHÔNG TÌM THẤY FILE BẠN ĐÃ NHẬP !")
    quit()
  list_email_fb = []
  ...
  def run_check_valid(emailfb):
    ...
    if kq_check == None:
      print (" ☇ |\033[1;37mHTOOL\033[1;32m|Có Liên Kết🙁 |" + emailfb)
      open(valid,"a").write(emailfb + "\n")
    else:
      print (" ☇ |\033[1;37mHTOOL\033[1;31m|Không Liên Kết🙁 |" + emailfb)
  with concurrent.futures.ThreadPoolExecutor() as executor:
...
def logo():
  logo = """
\033[1;35m_     _    _______  _____   _____ __
\033[1;35m| |  | |  |__   __|| ___ | | ___ |  |
\033[1;35m| |__| |     | |   ||   || ||    |  |
\033[1;93m|  __  |     | |   ||   || ||    |  |
\033[1;93m| |  | |     | |   \\\___// \\___//  |____
\033[1;93m\_|  |_/     \_/    \___/   \___/\______/


                 \033[1;33mⓒCopyright : Phạm Anh Quyết
                 \033[1;31mZalo : 0366301164
                 \033[1;23mFacebook : Phạm Anh Quyết 
...
\033[1;31m══════════════════════════════════════════════════════════════ 
\033[1;32m01. Tool Đào Mail.
\033[1;32m02. Tool Check Hotmail.
\033[1;32m03. Tool Check Yahoo.
\033[1;32m04. Tool Check Lk Facebook.
\033[1;32m05. Thoát Tool.
\033[1;31m ══════════════════════════════════════════════════════════════
...
"""
  for letter in menu:
  	...
  	sys.stdout.flush()
  	time.sleep(0.001)
  choice_user = input(" \033[1;93m*|HTOOL| Nhập Lựa Chọn : ")
  if choice_user == '1':
    clear()
    fakeEmail()
  if choice_user == '2':
